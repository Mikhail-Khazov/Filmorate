...
public class FeedLine {
    ...
    private void insertData(Long idUser, Long idEntity, String event, String operation) {
    ...
    public void afterReturningCallAtAddFriend(Long id, Long friendId) {
    ...
    public void afterReturningCallAtDeleteFriend(Long id, Long friendId) {
    ...
    public void afterReturningCallAtAddLikeFilm(Long filmId, Long userId) {
    ...
    public void afterReturningCallAtDeleteLikeFilm(Long filmId, Long userId) {
    ...
    public void afterReturningCallAtDeleteReview(Long idReview) {
